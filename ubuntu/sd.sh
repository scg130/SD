...
if [ "$flaggit" = 'y' ];then
    ...
    apt-get install kdelibs4-dev kdelibs4c2a -y
...
if [ "$flagpython" = 'y' ];then
    ...
    rm -fr /home/vipuser/anaconda3/bin/python
    ln -s /usr/local/python3.10/bin/python3.10 /home/vipuser/anaconda3/bin/python
    rm -fr /usr/bin/pip /home/vipuser/anaconda3/bin/pip
    ln -s /usr/local/python3.10/bin/pip3 /home/vipuser/anaconda3/bin/pip
